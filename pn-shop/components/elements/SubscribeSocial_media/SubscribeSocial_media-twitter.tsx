...
type SubscribeSocialMediaTwitter = {
  className: string
}

// Define the component function
const SubscribeSocialMediaTwitter: React.FC<SubscribeSocialMediaTwitter> = ({
  className,
}) => (
  <>
    <svg
...
export default SubscribeSocialMediaTwitter
