...
type SettingsSvgProps = {
  className: string
}

// Define the component function
const SettingsSvg: React.FC<SettingsSvgProps> = ({ className }) => (
  <>
    <svg
      className={className}
      width='24.000000'
